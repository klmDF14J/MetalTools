...
public class BlacksmithCraftingManager {
	/** The static instance of this class */
	private static final BlacksmithCraftingManager instance = new BlacksmithCraftingManager();
	 ...
	 */
	public static final BlacksmithCraftingManager getInstance() {
		return instance;
	}

	private BlacksmithCraftingManager() {
		for (int i = 0; i < Items.hammers.size(); i++) {
			Hammer hammer = Items.hammers.get(i);
			Item item = hammer.getItem();
			Object ing = hammer.getCraftingIngredient();
			int handleID = hammer.getHandle();
			ItemStack handle = new ItemStack(Items.handle, 1, handleID);
			addRecipe(new ItemStack(item), "XXX", "XYX", " Z ", 'X', ing, 'Y',
					Item.stick, 'Z', handle);
		}

		addRecipe(new ItemStack(Items.handle, 1, 0), new Object[] {
				"LSL", "LSL", 'L', 
				Item.leather, 'S', Item.stick });
		addRecipe(new ItemStack(Items.handle, 1, 1), new Object[] {
				"LSL", "LSL", 'L', Item.ingotIron, 'S', Item.stick });
		addRecipe(new ItemStack(Items.handle, 1, 2), new Object[] {
				"DSE", "LSL", 'L', Item.ingotGold, 'S', Item.stick, 'D',
				Item.diamond, 'E', Item.emerald });
